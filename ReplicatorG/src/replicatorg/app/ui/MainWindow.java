...
ToolpathGenerator.GeneratorListener
{
	...
	protected JMenu buildFileMenu() {
		...
		//R2C2: Scripts are not for RepRap 3D Printers
	 ...
	 * @returns a JMenu populated with Thingiverse items
	 */
	protected JMenu buildR2C2Menu()
	{
		JMenuItem item;
		JMenu menu = new JMenu("R2C2");
		
		item = new JMenuItem("About R2C2");
		item.addActionListener( new ActionListener(){
			//do bare bones launch
			@Override
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					try {
							java.awt.Desktop.getDesktop().browse(new java.net.URI("http://www.3dprinting-r2c2.com/?q=content/r2c2-documentation"));
					} catch (IOException e) {
						Base.logger.log(Level.WARNING, "Could not load URL.");
					} catch (java.net.URISyntaxException e) {
							Base.logger.log(Level.WARNING, "bad URI");
		...
		item = new JMenuItem("R2C2 User Manual");
		item.addActionListener( new ActionListener(){
			//do bare bones launch
			@Override
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					try {
						java.awt.Desktop.getDesktop().browse(new java.net.URI("http://www.3dprinting-r2c2.com/?q=content/r2c2-user-manual"));
					} catch (IOException e) {
						Base.logger.log(Level.WARNING, "Could not load URL.");
					} catch (java.net.URISyntaxException e) {
							Base.logger.log(Level.WARNING, "bad URI");
